    ...
    if($valid == 1){ 
        ...
        if($uploadStatus == 1){ 
            ...
            $query = "INSERT INTO tbl_blogs 
                    SET 
                        `blogs_title_en` = '{$blogs_title_en}',
                        `blogs_title_bn` = '{$blogs_title_bn}',
                        `blogs_description1_en` = '{$blogs_description1_en}',
                        `blogs_description1_bn` = '{$blogs_description1_bn}',
                        `blogs_description2_en` = '{$blogs_description2_en}',
                        `blogs_description2_bn` = '{$blogs_description2_bn}',
                        `blogs_tag_en` = '{$blogs_tag_en}',
                        `blogs_tag_bn` = '{$blogs_tag_bn}',
                        `blogs_category_en` = '{$blogs_category_en}',
                        `blogs_category_bn` = '{$blogs_category_bn}',
                        `blogs_time` = '{$blogs_time}',
                        `blogs_date` = '{$blogs_date}',
                        `blogs_year` = '{$blogs_year}',
