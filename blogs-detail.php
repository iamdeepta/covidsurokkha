...
<meta name="description" content="<?=$result['blogs_description1_en']?>">
...
<title class="notranslate">covidsurokkha | <?=$result['blogs_title_en']?></title>
...
<div id="blog_detail_section" style="margin-top: -10px">
  ...
  <div id="blog_detail_div" class="container" style="text-align: center;padding:0px 50px">
    ...
    <img id="blog_detail_image1" src="admin/files/blogs_images/<?php echo $result['blogs_image1'];?>" alt="covidsurokkha blog details image" style="border-radius: 20px;object-fit: cover;height: 506px;width: 870px" data-aos="zoom-in" data-aos-duration="1000">
    ...
    <div id="blog_detail_image2_div" data-aos="fade-right" data-aos-duration="1000"><img id="blog_detail_image2" src="admin/files/blogs_images/<?php echo $result['blogs_image2'];?>" alt="covidsurokkha blog details image" style="border-radius: 15px;height: 242px;width: 425px;object-fit: contain;"></div>
    <?php }else{?>
    <?php }?>
    <?php if($result['blogs_image3']!=''){?>
    <div id="blog_detail_image3_div" style="margin-left: 30px" data-aos="fade-left" data-aos-duration="1000"><img id="blog_detail_image3" src="admin/files/blogs_images/<?php echo $result['blogs_image3'];?>" alt="covidsurokkha blog details image" style="border-radius: 15px;height: 242px;width: 425px;object-fit: contain;"></div>
    <?php }else{?>
    <?php }?>
  </div>
  ...
  <div id="blog_detail_second_paragraph" style="text-align: left;padding: 0px 120px;margin-top: 0px;white-space: pre-line;" data-aos="zoom-in" data-aos-duration="1000">
    ...
    <img id="blog_detail_image3_mbl" src="admin/files/blogs_images/<?php echo $result['blogs_image3'];?>" alt="covidsurokkha blog details image" style="border-radius: 15px;object-fit: cover;height: auto;width: 100%;margin-top: -10px;" data-aos="fade-left" data-aos-duration="1000">
...
<div class="container" id="prev_next_div" style="display: flex;justify-content: space-between;flex-direction: row;">
   ...
   <?php if($result3['blogs_id']!=@$_GET['id']){?> 
    ...
    <p data-aos="fade-right" data-aos-duration="1000"><?=$result1['blogs_title_en']?></p>
  <?php }else{?>
  ...
  <?php if($result4['blogs_id']!=@$_GET['id']){?> 
    ...
    <p data-aos="fade-left" data-aos-duration="1000"><?=$result2['blogs_title_en']?></p>
...
<?php }else{?>
  <div class="container" id="prev_next_div" style="display: flex;justify-content: space-between;flex-direction: row;">
   ...
   <?php if($result3['blogs_id']!=@$_GET['id']){?> 
    ...
    <p data-aos="fade-right" data-aos-duration="1000"><?=$result1['blogs_title_bn']?></p>
  <?php }else{?>
  ...
  <?php if($result4['blogs_id']!=@$_GET['id']){?> 
    ...
    <p data-aos="fade-left" data-aos-duration="1000"><?=$result2['blogs_title_bn']?></p>
