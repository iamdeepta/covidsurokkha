...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<?php if(@$_GET['lang']=='en'){?>
<a class="navbar-brand" href="index.php?lang=en"><span style="font-size: 28px;font-weight:bold;color: #58547e"><img id="covidshebalogos" src="assets/images/logo.webp" alt="covid-surokkha-logo" style="width: 250px;height: 50px;object-fit: contain;"></span><!-- <img src="assets/images/logo.webp" srcset="assets/images/logo-2x.webp 2x" alt="" /> --><!-- <span id="covidlogo" style="font-size: 30px;font-weight: bold;color: #029e91;margin-left: -7px">covidsurokkha</span> --></a>
<?php }elseif(@$_GET['lang']=='bn'){?>
	<a class="navbar-brand" href="index.php?lang=bn"><span style="font-size: 28px;font-weight:bold;color: #58547e"><img id="covidshebalogos" src="assets/images/logo.webp" alt="covid-surokkha-logo" style="width: 250px;height: 50px;object-fit: contain;"></span><!-- <img src="assets/images/logo.webp" srcset="assets/images/logo-2x.webp 2x" alt="" /> --><!-- <span id="covidlogo" style="font-size: 30px;font-weight: bold;color: #029e91;margin-left: -7px">covidsurokkha</span> --></a>
<?php }else{?>
