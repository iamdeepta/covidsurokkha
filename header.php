...
<li class="nav-item dropdown info_icon_link" style="height: 70px;margin-top: -6px;margin-left: -8px;width: 30px" onclick="window.location.href='approved-laboratories.php'">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="border-radius: 8px;margin-left: -120px;display: none;margin-top: 10px">
          <a class="dropdown-item" href="approved-laboratories.php?lang=en" style="font: icon;padding: 5px;">Covid Test Centres For International Flights</a>
          
        </div>
    <?php }else{?>
    	<div class="dropdown-menu" aria-labelledby="navbarDropdown" style="border-radius: 8px;margin-left: -120px;display: none;margin-top: 10px">
          <a class="dropdown-item notranslate" href="approved-laboratories.php" style="font: icon;padding: 5px;">আন্তর্জাতিক ভ্রমণের জন্য কোভিড টেস্ট ল্যাবরেটরিজ</a>
