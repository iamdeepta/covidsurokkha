...
<li class="checker_btn" style="margin-left: -20px;">
	...
	<a id="english_btn" href="javascript:void(0)" onclick="change_lang_to_english()"><!-- <i class="linearicons-pulse"></i> --> ইংরেজি</a>
	<a style="display: none;" id="bengali_btn" href="javascript:void(0)" onclick="change_lang_to_bengali()"><!-- <i class="linearicons-pulse"></i> --> BENGALI</a>
...
<li class="checker_btn" style="margin-left: -40px;margin-top:0px">
	...
	<a id="english_btn1" href="javascript:void(0)" onclick="change_lang_to_english()" style="background: #01cfbe !important;padding: 5px;border-radius: 4px;color: white;font-size: 12px;"><!-- <i class="linearicons-pulse"></i> --> ইংরেজি</a>
	<a id="bengali_btn1" href="javascript:void(0)" onclick="change_lang_to_bengali()" style="background: #01cfbe !important;padding: 5px;border-radius: 4px;color: white;font-size: 12px;display: none;"><!-- <i class="linearicons-pulse"></i> --> BENGALI</a>
...
<img src="assets/images/icon/burger-white.png" alt="covid surokkha" />
</div>
</li>
</ul>
</div>
