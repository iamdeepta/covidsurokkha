...
<li style="margin-top: 0px">
	<?php if(@$_GET['lang']=='en'){?>
	<a href="vaccine.php?lang=en" style="line-height: 22px"><span style="font-size: 15px"><i class="fas fa-syringe" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>Vaccine Information</span></a>
<?php }else{?>

	<a class="notranslate" href="vaccine.php" style="line-height: 22px"><span style="font-size: 15px;"><i class="fas fa-syringe" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>ভ্যাকসিন তথ্য</span></a>
...
<li style="margin-top: 0px">
	<?php if(@$_GET['lang']=='en'){?>
	<a href="about_us.php?lang=en" style="line-height: 22px"><span style="font-size: 15px"><i class="fas fa-briefcase" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>About Us</span></a>
<?php }else{?>

	<a class="notranslate" href="about_us.php" style="line-height: 22px"><span style="font-size: 15px;"><i class="fas fa-briefcase" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>আমাদের সম্পর্কে</span></a>
